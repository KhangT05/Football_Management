...
export type PlayerWithoutTeamEntry = {
    ...
    ever_had_team: boolean; // true nếu từng có mặt trong TeamPlayerHistory
};
export type PlayersWithoutTeamStats = { total: number; players: PlayerWithoutTeamEntry[] };

export type PlayerLeaveEntry = {
    player_id: number; player_name: string;
    team_id: number; team_name: string;
    jersey_number: number; role: string;
