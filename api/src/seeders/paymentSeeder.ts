...
import { PrismaClient, PaymentStatus } from "../generated/prisma/client.js";
...
export async function seedPayments(
    ...
    for (const seasonTeamId of seasonTeamIds) {
        ...
        const status: PaymentStatus =
            roll < 0.85 ? PaymentStatus.confirmed : roll < 0.95 ? PaymentStatus.pending : PaymentStatus.refunded;
