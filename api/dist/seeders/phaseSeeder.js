export async function seedPhasesAndGroups(db, seasonId, teamIds // 8 teams
) {
    ...
    console.log(`  → GroupStage #${groupStagePhase.id} | GroupA #${groupA.id} | GroupB #${groupB.id}`);
...
//# sourceMappingURL=phaseSeeder.js.map