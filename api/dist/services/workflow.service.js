...
export class WorkflowService {
    ...
    async run(config) {
        ...
        const { phaseId: knockoutPhaseId, match: finalMatch } = await this._createAndRunFinal(seasonId, groupAWinner.teamId, groupBWinner.teamId, config.venueId);
     ...
     */
    async _createAndRunFinal(seasonId, homeTeamId, awayTeamId, venueId) {
        // Phase order
        const maxOrder = await this.prisma.phase.aggregate({
            where: { season_id: seasonId },
            _max: { order: true },
