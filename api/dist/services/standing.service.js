import { MatchResultStatus, MatchStatus } from '../generated/prisma/client.js';
// ─── Service ──────────────────────────────────────────────────────────────────
...
export class StandingsService {
    ...
    async recomputeGroupStandings(groupId) {
        ...
        const officialMatches = matches.filter(m => m.matchResult?.status === MatchResultStatus.official);
