...
import { LeaveReason, Prisma } from "../generated/prisma/client.js";
...
export class StatisticsService {
    ...
    async getTeamPlayerLeaveStats(filter = {}) {
        ...
        const reason_breakdown = Object.fromEntries(Object.values(LeaveReason).map((r) => [r, 0]));
        for (const b of breakdown) {
            if (b.left_reason)
                reason_breakdown[b.left_reason] = b._count._all;
        }
        return {
