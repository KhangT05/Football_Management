...
import { MatchEventType, MatchResultType, MatchStatus, PhaseFormat, Prisma, } from '../generated/prisma/client.js';
...
export class MatchResultService {
    ...
    async confirmResultInTx(tx, matchId, input) {
        ...
        await tx.match.update({
            where: { id: matchId },
            data: toMatchUpdateOnConfirm(resolution, targetMatchStatus, input.homeHalfTimeScore, input.awayHalfTimeScore),
        });
    ...
    async getMatchReport(matchId) {
        ...
        const goalsTimeline = buildGoalsTimeline(events, match.home_team_id, match.away_team_id, playerNameLookup, match.scheduled_at);
        return {
            matchId: match.id,
