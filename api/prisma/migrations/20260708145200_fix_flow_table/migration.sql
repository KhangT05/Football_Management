...
-- AlterTable
ALTER TABLE `seasons` ADD COLUMN `tournament_rule_id` INTEGER NULL;
...
-- AddForeignKey
ALTER TABLE `seasons` ADD CONSTRAINT `seasons_tournament_rule_id_fkey` FOREIGN KEY (`tournament_rule_id`) REFERENCES `tournament_rules`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;