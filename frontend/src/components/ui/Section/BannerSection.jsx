...
import { Search, Shield, Trophy, Users, Calendar, Swords, Loader2, ChevronRight } from "lucide-react";
                ...
                <div className="relative z-10 p-6 sm:p-10 md:p-16 lg:p-24 flex flex-col items-center text-center justify-center min-h-[380px] md:min-h-[460px]">
                    <div className="w-full max-w-4xl space-y-6 md:space-y-8">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto pt-2">
                            <Link
                                to="/tim-kiem-giai-dau"
                                className="px-3 py-3 md:px-4 md:py-4 flex flex-col items-center justify-center gap-2 bg-linear-to-br from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold rounded-2xl transition-all duration-300 shadow-lg shadow-blue-600/30 hover:-translate-y-1 text-xs sm:text-sm text-center"
                            >
                            ...
                            <Link
                                to="/tra-cuu-doi-bong"
                                className="px-3 py-3 md:px-4 md:py-4 flex flex-col items-center justify-center gap-2 bg-linear-to-br from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold rounded-2xl transition-all duration-300 shadow-lg shadow-emerald-600/30 hover:-translate-y-1 text-xs sm:text-sm text-center"
                            >
                                <span className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/15 shrink-0">
                            ...
                            <Link
                                to="/tra-cuu-cau-thu"
                                className="px-3 py-3 md:px-4 md:py-4 flex flex-col items-center justify-center gap-2 bg-linear-to-br from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-bold rounded-2xl transition-all duration-300 shadow-lg shadow-amber-600/30 hover:-translate-y-1 text-xs sm:text-sm text-center"
                            >
                                <span className="flex items-center justify-center w-10 h-10 rounded-xl bg-white/15 shrink-0">
