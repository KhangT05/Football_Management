...
function TeamRow({ name, score, showScore }) {
  ...
  return (
    <div className="flex justify-between items-center group/team w-full">
      ...
      {showScore && <span className="text-xl font-black text-white">{score}</span>}
    </div>
  );
}
      ...
      <div className="flex items-center pl-3">
        ...
        {!showScore && (
          <div className="shrink-0 ml-4 flex items-center justify-center">
            <span className="text-[11px] font-black text-blue-400 border border-blue-500/30 rounded-lg px-2.5 py-1.5 bg-blue-500/10 shadow-[0_0_10px_rgba(59,130,246,0.15)]">VS</span>
          </div>
        )}
      </div>
    </Link>
