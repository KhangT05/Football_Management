...
/**
 * mode: 'add' | 'edit'
 * onSubmitAdd({ user_email, date_of_birth, position, number })
...
export default function PlayerFormModal({
  ...
  const {
    ...
    defaultValues: isAdd
      ? { user_email: '', date_of_birth: '', position: 'MID', number: '' }
            ...
            <>
              <div className="space-y-2">
                ...
                <input
                  ...
                  {...register('user_email', { required: 'Vui lòng nhập email tài khoản của cầu thủ.' })}
                ...
                />
                <p className="text-[11px] text-gray-500 ml-1">Cầu thủ phải đã có tài khoản đăng ký trong hệ thống.</p>
