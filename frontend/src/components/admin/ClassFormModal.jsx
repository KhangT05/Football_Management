...
export default function ClassFormModal({ mode, initialData, isSaving, onSave, onClose }) {
  ...
  const validate = () => {
    const newErrors = {};
    if (!formData.name.trim()) newErrors.name = 'Tên lớp học không được để trống';
    setErrors(newErrors);
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 bg-gray-50 border ${
                errors.name ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500/20'
