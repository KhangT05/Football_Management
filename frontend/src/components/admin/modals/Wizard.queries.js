...
//     tournaments: () => ['tournaments', { active: true }] as const,
//     ruleTemplates: (tournamentId: string) => ['tournamentRules', tournamentId] as const,
// };

// export function useTournamentsQuery(enabled: boolean) {
//     return useQuery({
...
// export function useRuleTemplatesQuery(tournamentId: string | null) {
//     return useQuery({
//         queryKey: wizardKeys.ruleTemplates(tournamentId ?? ''),
//         queryFn: async () => {
//             const res = await tournamentRuleApi.getByTournament(tournamentId as string);
//             return res.data?.data ?? res.data ?? [];
//         },
...
//     warning: string | null;
//     finalFormat: string;
//     finalIsCustom: boolean;
//     customStagesCount: number;
// };

// export function useSubmitWizard(selectedRuleTemplate: any | null) {
//     const queryClient = useQueryClient();

//     return useMutation({
//         mutationFn: async (w: WizardFormValues): Promise<SubmitResult> => {
//             // 1. Tournament
...
//             let finalRuleId: string | number;
//             let finalFormat: string;
//             let finalCustomStages: any[] | null;
...
//             } else {
//                 const apiCustomStages = w.rule.format === 'custom' ? toApiCustomStages(w.rule.custom_stages as any) : null;
//                 const rulePayload = {
//                     ...w.rule,
