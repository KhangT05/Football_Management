// import type { CustomStage } from './wizard.schema';
// import { newCid } from './wizard.constants';
// import type { RuleFormValues } from './wizard.schema';
...
// export const toApiCustomStages = (stages: CustomStage[]) => {
...
// export const fromApiCustomStages = (stagesFromApi: any[] | null | undefined): CustomStage[] => {
...
// export const ruleDtoToFormValues = (rule: any): RuleFormValues => ({
//     name: rule.name ?? '',
//     format: rule.format,
