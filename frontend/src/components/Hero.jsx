...
export default function Hero() {
  return (
    <div className="relative min-h-[calc(100vh-80px)] flex flex-col justify-center overflow-hidden bg-navy-dark">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 py-12 md:py-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
        ...
        <div className="w-full lg:w-3/5 space-y-8 lg:pr-8 animate-slide-up relative z-20">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black leading-[1.1] tracking-tight text-white uppercase">
          ...
          <div className="flex flex-wrap items-center gap-5 pt-6">
            ...
            <Link 
              to="/bang-xep-hang" 
              className="w-full sm:w-auto px-8 py-4 bg-navy/50 backdrop-blur-md text-white font-bold rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 border border-navy-light uppercase tracking-wider text-sm group hover:bg-navy-light hover:border-gray-600 hover:-translate-y-1 shadow-lg"
            >
        ...
        <div className="w-full lg:w-2/5 flex justify-center lg:justify-end animate-fade-in" style={{ animationDelay: '200ms' }}>
          <div className="relative w-full max-w-md aspect-square flex flex-col justify-center gap-5">
            ...
            <div className="w-64 p-5 bg-navy/60 backdrop-blur-xl border border-navy-light/50 rounded-3xl shadow-2xl z-20 animate-float self-end mr-4">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 shrink-0 rounded-2xl bg-blue-500/20 flex items-center justify-center border border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.3)]">
                  <TrophyIcon className="w-7 h-7 text-blue-400" />
                </div>
                <div>
                  <p className="text-3xl font-black text-white tracking-tight">12<span className="text-blue-400">+</span></p>
            ...
            <div className="w-72 p-5 bg-navy-dark/80 backdrop-blur-xl border border-navy-light rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-30 animate-float-delayed self-start ml-2 -mt-2">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 shrink-0 rounded-2xl bg-emerald-500/20 flex items-center justify-center border border-emerald-500/30 shadow-[0_0_15px_rgba(16,185,129,0.3)]">
                  <Users className="w-7 h-7 text-emerald-400" />
                </div>
                <div>
                  <p className="text-3xl font-black text-white tracking-tight">48<span className="text-emerald-400">+</span></p>
            ...
            {/* Stat Card 3: Cầu thủ */}
            <div className="w-64 p-5 bg-navy/60 backdrop-blur-xl border border-navy-light/50 rounded-3xl shadow-2xl z-20 animate-float self-end mr-8 -mt-2" style={{ animationDelay: '400ms' }}>
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 shrink-0 rounded-2xl bg-purple-500/20 flex items-center justify-center border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.3)]">
                  <GraduationCap className="w-7 h-7 text-purple-400" />
                </div>
                <div>
                  <p className="text-3xl font-black text-white tracking-tight">850<span className="text-purple-400">+</span></p>
