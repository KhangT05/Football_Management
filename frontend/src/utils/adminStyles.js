/**
 * ============================================================
 * Admin Style Constants
 * ============================================================
 * Tailwind class strings dùng chung trong các trang admin.
...
export const BTN_SECONDARY = 'px-5 py-2.5 rounded-xl font-bold text-gray-300 bg-navy border border-navy-light hover:bg-navy-light hover:text-white shadow-md shadow-black/20 hover:shadow-black/30 flex items-center gap-2 transition-all active:scale-[.98]';

export const BTN_ICON = 'p-2.5 rounded-xl bg-navy border border-navy-light text-gray-400 hover:text-white hover:border-gray-500 shadow-md shadow-black/20 transition-all active:scale-[.98] disabled:opacity-50';
