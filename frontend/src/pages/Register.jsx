        ...
        <div className="p-8 sm:p-10">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div className="flex items-center my-4">
              <div className="grow border-t border-navy-light"></div>
              <span className="px-3 text-xs font-medium text-gray-400">Hoặc đăng ký với</span>
              <div className="grow border-t border-navy-light"></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                disabled={loading || isSuccess || socialLoadingProvider !== null}
                className="flex items-center justify-center py-2.5 px-4 rounded-xl border border-navy-light bg-navy-light/50 hover:bg-navy-light text-sm font-semibold text-slate-200 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
              ...
              >
                {socialLoadingProvider === 'github' ? (
                  ...
                  <svg className="w-5 h-5 mr-2 text-slate-200" fill="currentColor" viewBox="0 0 24 24">
