      ...
      <div className="max-w-7xl mx-auto space-y-6 pb-20 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-black text-white tracking-tight">Lịch Thi Đấu & Bốc Thăm</h2>
              <p className="text-gray-400 text-sm">Quản lý lịch, phân lịch tự động và chỉnh sửa thời gian</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-navy border border-navy-light rounded-2xl p-4 shadow-lg flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              disabled={!effectiveSeasonId || seasonsLoading}
